      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <h1 class="mb-0 bread">Blood Requirement Form</h1>
          </div>
        </div>
      </div>
    </div>
...
if (isset($_POST["submit_btn"])) {
  ...
  $insert = mysqli_query($connect, "insert into requirement(first_name, last_name, dob, city, age, weight, email, phone, blood_group) values('$first_name','$last_name','$dob','$city','$age','$weight','$email','$phone','$blood_group')") or die(mysqli_error($connect));
