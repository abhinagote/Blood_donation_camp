  ...
  <div class="container">
   ...
   <div class="text py-3 pb-4 px-3"><center>
    ...
    <thead>
          ...
          $query = mysqli_query($connect, "select * from donate") or die(mysqli_error($connect));
          $counter = 0;
          ...
          ?>
            <tbody>
              <tr>
                ...
                <td><center>
                  <a href="update_donation.php?ID=<?php echo $id; ?>">Update</a>
                  <a href="delete_donation.php?ID=<?php echo $id; ?>">Delete</a></center>
                </td>
              </tr>
            </tbody>
          <?php
